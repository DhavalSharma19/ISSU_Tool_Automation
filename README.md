...
Non-Disruptive Upgrade from kr6m to nr3f - https://earms-trade.cisco.com/tradeui/logs/details?archive=%2Fws%2Fdhavshar-bgl%2Fautomation%2Fpyats_venvs%2Fpyats_venv_05_2023%2Fusers%2Fdhavshar%2Farchive%2F23-07%2Fissu_job.2023Jul19_11:47:14.959927.zip&atstype=ATS

Disruptive Upgrade from kr6m to nr3f - https://earms-trade.cisco.com/tradeui/logs/details?archive=%2Fws%2Fdhavshar-bgl%2Fautomation%2Fpyats_venvs%2Fpyats_venv_05_2023%2Fusers%2Fdhavshar%2Farchive%2F23-07%2Fissu_job.2023Jul19_13:59:49.083455.zip&atstype=ATS
...
In this section we take the arguments given by the user in the issu_matrix.csv file and store the information. We store switch_alias, to_image(the image we want to upgrade or downgrade the box), to_image_path(the path where the image is located), upgrade_type(upgrade or downgrade), upgrade_subtype(disruptive or nondisruptive). Give lxc_issu as 0 if you dont want that else give 1. You can also provide with additional informtion i.e. epld_upgrade, epld_image and module_no in the issu_matrix file if you want to do epld_upgrade.
